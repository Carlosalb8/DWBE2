...
btnSalvar.onclick = e => {
  ...
  if (sNome.value == '' || sFuncao.value == '' || sSalario.value == '' || sTurma.value == '' || sProfessor.value == '') {
    return
  }
  ...
  if (id !== undefined) {
    ...
    itens.push({'nome': sNome.value, 'funcao': sFuncao.value, 'salario': sSalario.value, 'turma': sTurma.value, 'professor': sProfessor.value})
  }
